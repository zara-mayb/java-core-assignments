package com.zmb.login_and_registration.services;
...
import com.zmb.login_and_registration.repositories.UserRepository;
...
public class UserService {
    ...
    // TO-DO - Reject values: 
    	...
    	if(!BCrypt.checkpw(newLogin.getPassword(), user.getPassword())) {
    		result.rejectValue("email", "unique", "Invalid Password!");
    	}
